...
For more information, follow this blog: https://blogs.sap.com/2022/07/20/integrating-sap-signavio-process-intelligence-and-sap-data-intelligence-cloud-a-concrete-example-with-the-new-ingestion-api/
...
## Known Issues
Python operators contain a few lines of codes that can be adjusted based on your use case. For more information, follow this blog: https://blogs.sap.com/2022/07/20/integrating-sap-signavio-process-intelligence-and-sap-data-intelligence-cloud-a-concrete-example-with-the-new-ingestion-api/
